function aglomeradoFunction(feature) {
  ...
  var aglomerado = new ol.style.Style({
    image: new ol.style.Circle({
      radius: 2, // Raio do círculo em pixels
    ...
    text: new ol.style.Text({
      ...
      font: '12px Times New Roman', // Estilo da fonte (tamanho 10px, tipo Arial)
