...
function trechomassaFunction(feature) {
  var nome = feature.get('nome'); // Obtém o atributo 'nome' do objeto feature

  var trechomassa = new ol.style.Style({
    ...
    text: new ol.style.Text({
      ...
      font: 'italic bold 10px Century Gothic', // Estilo da fonte e tamanho
      fill: new ol.style.Fill({
  ...
  return [trechomassa]; // Retornamos um array de estilos, pois pode haver mais de um estilo para uma feature
}
