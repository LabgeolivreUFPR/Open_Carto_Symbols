...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" version="1.1.0" xmlns:se="http://www.opengis.net/se" xmlns:ogc="http://www.opengis.net/ogc">
  <NamedLayer>
    <se:Name>EDF_Edif_Saude_A</se:Name>
    <UserStyle>
      <se:Name>EDF_Edif_Saude_A</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <!--Parametric SVG-->
              <se:ExternalGraphic>
                <se:OnlineResource xlink:type="simple" xlink:href="C:/PROGRA~1/QGIS3~1.4/apps/qgis-ltr/svg/emergency/amenity=hospital.svg?fill=%23ff0000&amp;fill-opacity=1&amp;outline=%23000000&amp;outline-opacity=1&amp;outline-width=0"/>
          ...
          <se:TextSymbolizer>
            ...
            <se:LabelPlacement>
              <se:PointPlacement>
                ...
                <se:Displacement>
                  <se:DisplacementX>7.07</se:DisplacementX>
                  <se:DisplacementY>7.07</se:DisplacementY>
                </se:Displacement>
              </se:PointPlacement>
            </se:LabelPlacement>
            <se:Fill>
